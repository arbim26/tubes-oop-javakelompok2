...
public class ManagerKeuangan {
    ...
    public void tambahTransaksi(String deskripsi, double jumlah, KategoriTransaksi kategori, String tanggalStr)
        throws NumberFormatException, IllegalArgumentException, NegativeAmountException {
